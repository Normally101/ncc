...
window.renderP2PMarketSection = function() {
    ...
    if (myListings.length > 0) {
        html += `<div style="font-size:8px;color:#6b7280;text-transform:uppercase;letter-spacing:.08em;border-bottom:1px solid #21262d;padding-bottom:4px;margin-bottom:8px;margin-top:12px">I Miei Annunci</div>`;
            ...
            <div class="finance-stock-card" style="margin-bottom:8px">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:4px">
                    ...
                    <div style="text-align:right">
                        ...
                        <div style="font-size:8px;color:#6b7280">${s.shares_available} disp. / ${s.shares_total} tot.</div>
                    </div>
                </div>
...
window.renderP2PHoldingsSection = function() {
    ...
    let html = `<div style="font-size:8px;color:#c79a2a;text-transform:uppercase;letter-spacing:.1em;border-bottom:1px solid #21262d;padding-bottom:4px;margin-bottom:12px;margin-top:16px">⚔️ Sindacati P2P Reali</div>`;
    ...
    if (myH) {
        ...
        if (holdings.length > 0) {
            html += `<div style="font-size:8px;color:#6b7280;text-transform:uppercase;margin-bottom:8px">Sindacati disponibili</div>`;
...
window.renderBarometroWidget = function() {
    ...
    <div style="background:${bgColor};border:1px solid ${barColor}33;border-radius:6px;padding:14px;margin-bottom:12px">
        ...
        <div style="height:8px;border-radius:4px;background:#21262d;overflow:hidden;margin-bottom:4px">
            <div style="height:100%;width:${Math.round(t)}%;background:${barColor};border-radius:4px;transition:width .5s"></div>
        </div>
        <div style="font-size:8px;color:#6b7280">Contribuisci alla cassa del tuo Sindacato per abbassare la tensione · €10.000 = −1 punto</div>`;
    ...
    if (ss.strikeActive) {
        ...
        <div style="margin-top:8px;padding:8px;border-radius:4px;background:rgba(248,81,73,0.1);border:1px solid rgba(248,81,73,0.35)">
            ...
            <div style="font-size:8px;color:#6b7280;margin-top:2px">Puoi assumere crumiri nell'Ispettorato per mantenere i redditi</div>
        </div>`;
    }
...
window.renderP2PConsorziSection = function() {
    ...
    let html = `<div style="font-size:8px;color:#c79a2a;text-transform:uppercase;letter-spacing:.1em;border-bottom:1px solid #21262d;padding-bottom:4px;margin-bottom:12px;margin-top:16px">🤝 Consorzi — Gilde Cooperative</div>`;
    ...
    <div style="display:flex;gap:8px;margin-bottom:12px">
        <div style="flex:1;background:#161b22;border:1px solid #21262d;border-radius:6px;padding:6px;text-align:center">
            ...
            <div style="font-size:7px;color:#6b7280">${fuelBonus ? '✅ Attivo' : '≥3 membri'}</div>
        </div>
        <div style="flex:1;background:#161b22;border:1px solid #21262d;border-radius:6px;padding:6px;text-align:center">
            <div style="font-size:8px;color:${incomeBonus?'#1aa06a':'#6a7480'}">💰 +8% redditi</div>
            <div style="font-size:7px;color:#6b7280">${incomeBonus ? '✅ Attivo' : '≥5 membri'}</div>
        </div>
    </div>`;
    ...
    if (myC) {
        ...
        if (consorzi.length > 0) {
            html += `<div style="font-size:8px;color:#6b7280;text-transform:uppercase;margin-bottom:8px">Consorzi disponibili</div>`;
...
window.renderIspettoratoSection = function() {
    ...
    let html = `<div style="font-size:8px;color:#c79a2a;text-transform:uppercase;letter-spacing:.1em;border-bottom:1px solid #21262d;padding-bottom:4px;margin-bottom:12px;margin-top:16px">🔍 Ispettorato del Lavoro</div>`;
    ...
    <div style="background:#161b22;border:1px solid ${riskColor}22;border-radius:6px;padding:14px;margin-bottom:12px">
        ...
        <div style="height:6px;border-radius:3px;background:#21262d;overflow:hidden;margin-bottom:6px">
...
window.payDonCarmine = async function() {
    ...
    if ((gameState.cash || 0) < cost) {
        showNotification(`Fondi insufficienti (costo €${cost.toLocaleString()})`, 'error');
        return;
    }
