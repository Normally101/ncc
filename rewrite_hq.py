...
hq_js_path = r"E:\Documenti\Python Projects\ItalyExecutive\hq.js"

new_hq_js = """'use strict';
/* ================================================================
...
with open(hq_js_path, "w", encoding="utf-8") as f:
    f.write(new_hq_js)

print("hq.js has been rewritten successfully.")
