...
visual_js_path = r"E:\Documenti\Python Projects\ItalyExecutive\hq-visual.js"

new_visual_js = """'use strict';
/* ================================================================
...
with open(visual_js_path, "w", encoding="utf-8") as f:
    f.write(new_visual_js)

print("hq-visual.js rewritten successfully for Ikariam style.")
