...
describe('genera docs/AZIONI.md se non esiste la tabella', () => {
    test('scrittura manuale una-tantum', () => {
        const generated = generateUnifiedDoc();
        fs.writeFileSync(DOC_PATH, generated.md, 'utf8');
    });
});
