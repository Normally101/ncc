...
const CORE_FILES = [
    ...
    'engine-rivals.js', 'engine-events.js', 'vip-buffs.js', 'vip-clients.js', 'ui-emails.js',
    'ui-staff.js', 'ui-ops.js', 'ui-ranking.js', 'alliances.js', 'vanity.js', 'ui-store.js',
    'world-feed.js', 'daily-orders.js', 'zero-to-hero.js', 'vittorio.js', 'showroom.js',
    'vtk-market.js', 'p2p-market.js', 'p2p-render.js', 'b2b.js', 'auctions.js',
    'driver_skills.js', 'black_ops.js', 'crypto.js', 'hq-data.js', 'hq.js',
    'hostile_takeover.js', 'nemesis.js', 'infrastructure.js', 'contracts.js', 'tourism.js'
];
