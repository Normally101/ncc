'use strict';
/* ================================================================
   ui-landing.js — Chauffeur Empire
   Landing page / auth overlay: _showAuthOverlay, login form,
   signup form, showcase, rankings, auth helpers.
   Loaded BEFORE auth.js.
   Dipendenze: supabase-config.js, design-system.js
   ================================================================ */
