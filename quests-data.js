...
const QUEST_DB = [
  ...
  { id:'t06', ch:1, type:'tutorial', tier:'silver', icon:'🕵️',
    ...
    bivio:{
      ...
      options:[
        { id:'rifiuta', label:'Rifiuta', desc:'Mantieni la reputazione pulita.', effect: gs => { if (window.CE_money) window.CE_money.addReputation(0.2); else gs.reputation = Math.min(5.0+(gs.prestige||0), (gs.reputation||0)+0.2); } },
        { id:'accetta', label:'Accetta', desc:'€5.000 subito, ma rischi una multa GdF.', effect: gs => { if (window.CE_money) window.CE_money.earn(5000, 'bivio'); else gs.cash = (gs.cash||0) + 5000; } }
      ]
    },
  ...
  { id:'m01', ch:2, type:'story', tier:'silver', icon:'👁️',
    ...
    bivio:{
      ...
      options:[
        { id:'rifiuta', label:'Rifiuta', desc:'+Reputazione', effect: gs => { if (window.CE_money) window.CE_money.addReputation(0.2); else gs.reputation = Math.min(5.0+(gs.prestige||0), (gs.reputation||0)+0.2); } },
        { id:'accetta', label:'Accetta deviazione', desc:'+€150.000 ma -0.5★', effect: gs => { if (window.CE_money) { window.CE_money.earn(150000, 'bivio'); window.CE_money.addReputation(-0.5); } else { gs.cash = (gs.cash||0) + 150000; gs.reputation = Math.max(0, (gs.reputation||0)-0.5); } } }
      ]
    },
  ...
  { id:'m02', ch:2, type:'story', tier:'silver', icon:'👗',
    ...
    bivio:{
      ...
      options:[
        { id:'rifiuta', label:'Rifiuta stop', desc:'+0.1★', effect: gs => { if (window.CE_money) window.CE_money.addReputation(0.1); else gs.reputation = Math.min(5.0+(gs.prestige||0), (gs.reputation||0)+0.1); } },
        { id:'accetta', label:'Accetta stop', desc:'+€20.000 ma -0.3★', effect: gs => { if (window.CE_money) { window.CE_money.earn(20000, 'bivio'); window.CE_money.addReputation(-0.3); } else { gs.cash = (gs.cash||0) + 20000; gs.reputation = Math.max(0, (gs.reputation||0)-0.3); } } }
      ]
    },
  ...
  { id:'m03', ch:2, type:'story', tier:'silver', icon:'🏛️',
    ...
    bivio:{
      ...
      options:[
        { id:'rifiuta', label:'Devia regolare', desc:'+0.15★', effect: gs => { if (window.CE_money) window.CE_money.addReputation(0.15); else gs.reputation = Math.min(5.0+(gs.prestige||0), (gs.reputation||0)+0.15); } },
  ...
  { id:'m04', ch:2, type:'story', tier:'silver', icon:'🕴️',
    ...
    bivio:{
      ...
      options:[
        ...
        { id:'accetta', label:'Passa senza fermarsi', desc:'Perdi la fiducia di Grigori', effect: gs => { if (window.CE_money) window.CE_money.addReputation(-0.1); else gs.reputation = Math.max(0, (gs.reputation||0)-0.1); } }
      ]
    },
  ...
  { id:'m05', ch:2, type:'story', tier:'gold', icon:'💻',
    ...
    bivio:{
      ...
      options:[
        { id:'rifiuta', label:'Cash tradizionale', desc:'+€100.000', effect: gs => { if (window.CE_money) window.CE_money.earn(100000, 'bivio'); else gs.cash = (gs.cash||0) + 100000; } },
