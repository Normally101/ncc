...
function renderTabFleet() {
    ...
    if (!container) return;
    const _ff = window._fleetFilter || { brand: null, tier: null };
    ...
    if (hasDepot) {
        ...
        <div class="em-card" style="padding:14px;margin-bottom:7px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:5px;margin-bottom:12px">
                ...
                <button ${ceAct('buyTiresForDepot', [5])}  class="em-bbtn" style="text-align:center;padding:5px">+5 set<br><span style="font-size:9px;opacity:.7">€4.000</span></button>
                <button ${ceAct('buyTiresForDepot', [10])} class="em-goldbtn" style="text-align:center;padding:5px">+10 set<br><span style="font-size:9px;opacity:.8">€8.000</span></button>
            </div>
            ${(() => {
