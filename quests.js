'use strict';
/* ================================================================
   quests.js — Chauffeur Empire
   Quest engine: completeMissionRun, getMissionRequires,
   checkQuestProgress, claimQuestReward.
   Dipendenze: quests-data.js (QUEST_DB), engine.js (gameState, saveGame)
   ================================================================ */
...
// QUEST_DB already exported by quests-data.js
