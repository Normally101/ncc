...
- `listCarForSale` · `p2p-market.js:60` · data-ce-act: `listCarForSale` (`ui-market.js`) · doppioni: `engine-fleet.js:413` · denaro: RPC (`rpc_list_car_for_sale`)
...
| `listCarForSale` | `p2p-market.js:60` | `engine-fleet.js:413` | P2P market (`p2p-market.js`) sovrascrive la vendita flotta standard (`engine-fleet.js`) |
