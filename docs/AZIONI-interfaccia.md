...
- `renderTabFleet` · `ui-fleet.js:6` · data-ce-act: nessuna · doppioni: nessuno · denaro: no
- `bulkRepairFleet` · `ui-fleet.js:411` · data-ce-act: `bulkRepairFleet` (`ui-fleet.js`) · doppioni: nessuno · denaro: no
- `renderTabFleet` · `ui-fleet.js:427` · data-ce-act: nessuna · doppioni: nessuno · denaro: no
