...
|---|---|---|---|
| `_kpi` | `ui-finance.js:87` | `ui-ranking.js:105` | Helper locale duplicato in scope globale (ui-finance.js e ui-ranking.js) |
| `buyHRAutomation` | `ui-ops.js:218` | `serverState.js:534` |  |
| `switchTab` | `ui-sidebar.js:64` | `dispatcher.js:150, em-chrome.js:32, motion.js:164, premium-ui.js:12, zero-to-hero.js:182` | Decoratore / wrapper globale dell'interfaccia |
| `updateUI` | `ui-sidebar.js:85` | `engine.js:1995, objective-tracker.js:147` | Decoratore / wrapper globale dell'interfaccia |
...
## Segnalazione speciale: Configuratore Auto in `ui-staff.js`

Il configuratore auto in `ui-staff.js` (righe ~400–585, circa 185 righe) comprende le funzioni:
- `openCarConfigurator` (ui-staff.js:400)
- `_updateSummary` (ui-staff.js:490)
- `__cfgToggle` (ui-staff.js:516)
- `__cfgConfirm` (ui-staff.js:537)
- `buyCar` (ui-staff.js:583)
- `leaseCar` (ui-staff.js:585)

Questo blocco era stato identificato come codice orfano/morto nell'analisi del 19/08/2026 poichè l'acquisto veicoli primario è gestito da `showroom.js` (`renderTabShowroom`, `_srmPurchase`), mentre la vendita/gestione flotta è in `engine-fleet.js` e `p2p-market.js`.
